...
# Exaltation/own/debilitation tables — kept here because this evaluator
# intentionally extends features/dignity.py with Rahu/Ketu entries.
# Do NOT merge into evaluator_base (domain-semantic decision, not plumbing).
EXALTATION_SIGNS = {
