"""
Career Authority & Institutional Power Event Pack — 5-Layer Semantic Architecture
"""
import json, os
...
def get_outcome_quality(): return _load_json("outcome_quality.json")
def get_calibration_overlay(): return _load_json("calibration_overlay.json")
def get_all_rules():
    return get_dasha_rules() + get_transit_rules() + get_fast_trigger_rules() + get_classical_patterns() + get_outcome_quality()
